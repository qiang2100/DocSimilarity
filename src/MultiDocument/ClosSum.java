...
public class ClosSum {
	...
	public ClosSum(double belt)
	{	
		this.belt = belt;
	}
	
	public ClosSum(int lenQ)
	{
		this.lenQ = lenQ;
	}
	
	public ClosSum(int min1, int min2)
	{
		this.min1 = min1;
		this.min2 = min2;
	}
	...
	public ClosSum(long sup)
	{
		this.sup = sup;
	}
	
	public ClosSum(int lenQ, double belt)
	{
		this.lenQ = lenQ;
		this.belt = belt;
	}
	...
	public void extractSentenceFromDir(String filePath, MaxentTagger tagger) throws Exception
	{
		...
		for(int i=0; i<fileList.length; i++)
		{
			...
			//System.out.println("---------------------------------------------");
			 ...
			 HashMap<ArrayList, Integer> patHash = getClos(buff, sentences.size());
	...
	public void computWeight( HashMap<ArrayList, Integer> patHash, int numOfSent)
	{
		...
		while (iter.hasNext()) 
		{
			...
			//{
				...
				//double weight = (double)sup*it.size();
	...
	HashMap<ArrayList,Integer> getClos(String buff, int numOfSent) throws Exception 
	{
...
//					}
				...
				double wordWeight = 1;
				//if(lenQ!=0)
				wordWeight = ((double)usefulWord+(double)sentWordNum.get(i)/lenQ)/sentWordNum.get(i);
